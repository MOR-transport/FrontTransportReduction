...
from NeuralFTR.utils import save_codeBase, to_torch
import os
...
class Trainer(object):
    ...
    def __init__(self,
        ...
        self.Dx_kernel = torch.ones([1, 1, 2, 1], device=self.device, dtype=dtype) / self.dx
        self.Dy_kernel = torch.ones([1, 1, 1, 2], device=self.device, dtype=dtype) / self.dy
    ...
    def training(self, batch_size, trainsteps=1e5, test_every=1e3, save_every=5e3, test_batch_size=None, log_base_name=''):
