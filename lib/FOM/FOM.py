...
class params_class:
    def __init__(self, pde = "advection",dim = 2 ,L=[1,1] ,N = [2**7, 2**6], T=0.1, Nt=300 , case="bunsen_flame"):
        ...
        self.reaction_const = 1e1    # adjust the propagation of the flame (larger value = faster propagation)
        self.dim = dim
